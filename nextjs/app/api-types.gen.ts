...
export interface components {
    schemas: {
        ...
        Tournament: {
            ...
            /** Format: date-time */
            end_date: string;
            /** @description List of participant player IDs (integers) */
            players: number[];
        };
        ...
        requestBody: {
            content: {
                "application/json": {
                    ...
                    /**
                     * Format: uuid
                     * @description Optional idempotency key generated by the client. A repeated request with the same key returns the already-created player instead of creating a duplicate.
                     */
        ...
        requestBody: {
            content: {
                "application/json": {
                    ...
                    /**
                     * Format: uuid
                     * @description Optional idempotency key generated by the client. A repeated request with the same key returns the already-created game instead of creating a duplicate.
                     */
                    idempotency_key?: string;
                };
            };
        ...
        requestBody: {
            content: {
                "application/json": {
                    ...
                    /**
                     * Format: uuid
                     * @description Optional idempotency key generated by the client. A repeated request with the same key returns the already-created match instead of creating a duplicate.
                     */
                    idempotency_key?: string;
